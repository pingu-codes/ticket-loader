...
exports.resume = exports.go_scheduler = exports._start = exports.memset = exports.memcpy = exports.__wasm_call_ctors = exports.memory = void 0;
var _env = window._env // import { fd_write } from "wasi_unstable";
...
/** @noinline Inlining this function would mean expanding the base64 string 4x times in the source code, which Closure seems to be happy to do. */ function base64DecodeToExistingUint8Array(
  uint8Array,
  offset,
  b64
) {
...
var retasmFunc = asmFunc(
  ...
  },
  {
    ...
    syscall_js_valueLength: _env.syscall_js_valueLength,
    syscall_js_valueIndex: _env.syscall_js_valueIndex,
    runtime_ticks: _env.runtime_ticks,
    runtime_sleepTicks: _env.runtime_sleepTicks,
    syscall_js_valueCall: _env.syscall_js_valueCall,
    syscall_js_valueGet: _env.syscall_js_valueGet,
    syscall_js_valueNew: _env.syscall_js_valueNew,
    syscall_js_valueSet: _env.syscall_js_valueSet,
    syscall_js_valueSetIndex: _env.syscall_js_valueSetIndex,
    syscall_js_stringVal: _env.syscall_js_stringVal,
    syscall_js_valuePrepareString: _env.syscall_js_valuePrepareString,
    syscall_js_valueLoadString: _env.syscall_js_valueLoadString,
    getTempRet0: _env.getTempRet0
  },
  memasmFunc
);
...
var memcpy = retasmFunc.memcpy;
exports.memcpy = memcpy;
var memset = retasmFunc.memset;
exports.memset = memset;
var _start = retasmFunc._start;
exports._start = _start;
var go_scheduler = retasmFunc.go_scheduler;
exports.go_scheduler = go_scheduler;
var resume = retasmFunc.resume;
