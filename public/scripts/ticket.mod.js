...
logFunc(Reflect, "set");
logFunc(Reflect, "get");
logFunc(Reflect, "apply");
logFunc(Reflect, "construct");
// function debugAccess(obj, prop, name) {
//   var origValue = obj[prop];
//   Object.defineProperty(obj, prop, {
//     get: function() {
//       // if (debugGet) debugger;
...
// debugAccess(Reflect, "get", "Reflect.get");
var $jscomp = $jscomp || {};
$jscomp.scope = {};
  ...
  function(a) {
    ...
    f.prototype.callWhenSettled_ = function(a, b) {
      ...
      null == this.onSettledCallbacks_
        ? h.asyncExecute(d)
        : this.onSettledCallbacks_.push(d);
    };
    f.resolve = e;
    f.reject = function(a) {
    ...
    f.race = function(a) {
      return new f(function(b, d) {
        for (
          var c = $jscomp.makeIterator(a), l = c.next();
          !l.done;
          l = c.next()
        )
          e(l.value).callWhenSettled_(b, d);
      });
    };
    f.all = function(a) {
      ...
      return d.done
        ...
        : new f(function(a, c) {
            ...
            do
              k.push(void 0),
                l++,
                e(d.value).callWhenSettled_(m(k.length - 1), c),
                (d = b.next());
            while (!d.done);
          });
    };
...
$jscomp.initSymbolIterator = function() {
  ...
  a ||
    (a = $jscomp.global.Symbol.iterator = $jscomp.global.Symbol(
      "Symbol.iterator"
    ));
        ...
        if (d && $jscomp.owns(a.data_, c))
          for (a = 0; a < d.length; a++) {
            ...
            if ((b !== b && k.key !== k.key) || b === k.key)
              return { id: c, list: d, index: a, entry: k };
          }
...
$jscomp.polyfill(
  ...
  function(a) {
    console.log("Reflect.getOwnPropertyDescriptor", a);
...
$jscomp.polyfill(
  ...
  function(a) {
    return a
      ? a
      : $jscomp.ASSUME_ES5 || "function" == typeof Object.isExtensible
      ? Object.isExtensible
      : function() {
          return !0;
        };
  ...
  function(a) {
    return a
      ...
      : function(a, e, g, f) {
          ...
          return b
            ? b.set
              ? (b.set.call(3 < arguments.length ? f : a, g), !0)
              : b.writable && !Object.isFrozen(a)
              ? ((a[e] = g), !0)
              : !1
            : Reflect.isExtensible(a)
            ? ((a[e] = g), !0)
            : !1;
        };
  },
...
try {
  (function() {
    ...
    global.Go = function() {
      ...
      var c = function() {
        ...
        d = function(b, d) {
          if ("number" === typeof d)
            isNaN(d)
              ? (c().setUint32(b + 4, 2146959360, !0), c().setUint32(b, 0, !0))
              : 0 === d
              ? (c().setUint32(b + 4, 2146959360, !0), c().setUint32(b, 1, !0))
              : c().setFloat64(b, d, !0);
          else {
            switch (d) {
              case void 0:
            ...
            var f = a._refs.get(d);
            void 0 === f &&
              ((f = a._values.length), a._values.push(d), a._refs.set(d, f));
            var e = 0;
            switch (typeof d) {
              case "string":
                e = 1;
      ...
      console.log("window_env");
      window._env = this.importObject.env;
    };
      ...
      return $jscomp.asyncExecutePromiseGeneratorProgram(function(c) {
        1 == c.nextAddress &&
          ...
          (b._values = [
            ...
            !1,
            global,
            b._inst.exports.memory,
            b
          ]),
          (b._refs = new Map()),
          (b._callbackShutdown = !1),
          (b.exited = !1),
          new DataView(b._inst.exports.memory.buffer));
        ...
        return b.exited ? c.jumpTo(0) : c.yield(e, 2);
      });
    };
    ...
    global.Go.prototype._makeFuncWrapper = function(a) {
      var b = this;
      return function() {
        var c = { id: a, this: this, args: arguments };
        b._pendingEvent = c;
        b._resume();
        return c.result;
      };
      ...
      (WebAssembly.instantiateStreaming = function(a, b) {
        ...
        return $jscomp.asyncExecutePromiseGeneratorProgram(function(d) {
          switch (d.nextAddress) {
            ...
            case 2:
              return (
                (c = d.yieldResult), d.yield(WebAssembly.instantiate(c, b), 4)
              );
            case 4:
    ...
    window.wasmObj = new Go();
    var f = wasmObj;

    wasm = complete(window._env);
    f.run(wasm);

    // debugAccess(wasmObj._inst.exports, "memory");
    // WebAssembly.instantiateStreaming(fetch(window.wasmbinsrc), f.importObject)
    //   .then(function(a) {
    //     wasm = a.instance;
    //     f.run(wasm);
    //   })
